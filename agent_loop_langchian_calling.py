...
MAX_ITERATIONS = 10
MODEL = "qwen2.5:7b" # qwen2.5:7b, qwen3.5:0.8b(not working)
...
def apply_discount_price(price: float, discount_tier: str) -> float:
    """
    Apply discount filter to the price and reteurn the final price
    Available tier bronze, silver, gold.
    """
...
def run_agent(question: str):
    tools = [get_product_price, apply_discount_price]
